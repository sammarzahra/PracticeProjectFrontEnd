...
const Menu = () => {
  ...
  return (
    <div className=" w-64 h-auto  ">
      ...
      <div className={`mt-7 ml-6 py-3 px-3 pb-4 md:h-11 md:w-52 bg-white rounded-xl flex border-2 border-[#F1F5F9] ${
      ...
      <div  className={`mt-7 ml-6 text-[#4BCBEB] py-3 px-3 md:h-11 md:w-52 bg-white rounded-xl flex border-2 border-[#F1F5F9] ${
